...
export function tracesView(catalog, params, search, catalogResult = null) {
  const q = params.get("q") || "",
    format = ["codex", "pi", "claude"].includes(params.get("format"))
      ? params.get("format")
      : "";
